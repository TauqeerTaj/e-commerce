...
//Interface
import { ProfileInterface } from "@/constant/profileInterface";
//Styles
...
function Form() {
  ...
  useEffect(() => {
    if (
      profileData.confirmPassword.length &&
  ...
  const updateUser = async (userData: ProfileInterface) => {
  ...
  return (
    <Box
      sx={{
        p: "50px 60px 50px 60px",
        boxShadow:
          "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)",
      }}
    >
      <Typography className={Styles.formHeading}>Edit Your Profile</Typography>
      <FormControl
        component="form"
        sx={{ width: "100%" }}
